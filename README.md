...
We also show a table of the indices of the removed layers for folded ResNet and VGG networks such that their resulting depth corresponds to their EDNL. It can be deriven from this table, what is the significant activation in each architecture.
<p align="center">
